    ...
    <>
      ...
      <style>{`
        ...
        .hero-video {
          ...
          top: 50%;
          left: 50%;
          /* Keep video covering full area at all aspect ratios */
          min-width: 100%;
          min-height: 100%;
          width: auto;
          height: auto;
        ...
        /* Multi-layer overlay:
           1. Deep forest-green gradient at top/bottom for text readability
           2. Subtle warm centre glow to preserve the natural video warmth
           3. Overall darkening tint so cream-coloured text pops */
        .hero-video-overlay {
          position: absolute;
          inset: 0;
          background:
            /* top fade — keeps ticker readable */
            linear-gradient(to bottom,
              rgba(10, 28, 20, 0.72) 0%,
              rgba(10, 28, 20, 0.30) 25%,
              rgba(10, 28, 20, 0.18) 50%,
              rgba(10, 28, 20, 0.35) 75%,
              rgba(10, 28, 20, 0.65) 100%
            ),
            /* left-side stronger fade so left text column is always legible */
            linear-gradient(to right,
              rgba(8, 24, 16, 0.60) 0%,
              rgba(8, 24, 16, 0.25) 55%,
        ...
        /* ══════════════════════════════════════
           BACKGROUND GRADIENTS (blobs kept for
           layering on top of video for extra depth)
        ══════════════════════════════════════ */
        .hero-bg {
          position: absolute;
          inset: 0;
          pointer-events: none;
          overflow: hidden;
          z-index: 2; /* sits above the video overlay */
        }
        .blob {
          position: absolute;
          border-radius: 50%;
        ...
        .blob-3 {
          width: 360px; height: 360px;
          top: 38%; right: 28%;
          background: radial-gradient(circle, rgba(239,68,68,.04) 0%, transparent 70%);
        }
        .grid-lines {
          position: absolute;
          inset: 0;
        ...
        /* ══════════════════════════════════════
           LEFT — TEXT COLUMN
           (adapted for dark video bg — text colours
            shifted to light where needed)
        ══════════════════════════════════════ */
        .left-col {
          display: flex;
          flex-direction: column;
        ...
        .benefit-card:hover {
          transform: translateY(-2px) translateX(3px);
          box-shadow: 0 8px 28px rgba(0,0,0,.20), inset 0 1px 1px rgba(255,255,255,.12);
        }
        .benefit-icon {
          width: 36px; height: 36px;
          border-radius: 10px;
        ...
        .btn-primary:hover {
          transform: translateY(-2px);
          box-shadow: 0 10px 32px rgba(5,150,105,.50), inset 0 1px 1px rgba(255,255,255,.12);
        }
        .btn-primary:active { transform: translateY(0); }
        .btn-primary::after {
          content: '';
        ...
        .btn-secondary:hover {
          ...
          box-shadow: 0 8px 28px rgba(0,0,0,.18), inset 0 1px 1px rgba(255,255,255,.15);
        }
        .play-bubble {
          width: 34px; height: 34px;
          border-radius: 50%;
        ...
        .orb {
          ...
          box-shadow:
            0 30px 80px rgba(16,185,129,.25),
        ...
        .orb-shine {
          ...
          inset: 0;
          border-radius: 50%;
          background: conic-gradient(from 0deg, transparent 55%, rgba(255,255,255,.30) 65%, rgba(255,255,255,.10) 75%, transparent 85%);
          animation: spinCW 8s linear infinite;
          will-change: transform;
          transform-origin: center center;
        }
        ...
        .orb-disk {
          width: 100px; height: 100px;
          border-radius: 50%;
          background: linear-gradient(145deg, #059669 0%, #0f3d2e 60%, #0d9488 100%);
          display: flex; align-items: center; justify-content: center;
          margin: 0 auto 10px;
          box-shadow: 0 8px 32px rgba(5,150,105,.50), inset 0 1px 2px rgba(255,255,255,.15);
          position: relative;
          overflow: hidden;
        }
        @media(min-width: 1024px) { .orb-disk { width: 130px; height: 130px; } }
        .orb-disk::before {
          ...
          inset: 0;
          border-radius: 50%;
          background: radial-gradient(ellipse at 35% 25%, rgba(255,255,255,.22) 0%, transparent 60%);
        }
        .orb-emoji { font-size: 3rem; position: relative; z-index: 1; }
        @media(min-width: 1024px) { .orb-emoji { font-size: 4rem; } }
        .orb-title {
        ...
        .pill::before {
          ...
          position: absolute;
          inset: 0;
          background: linear-gradient(135deg, rgba(255,255,255,.18) 0%, rgba(255,255,255,.04) 30%, transparent 50%);
          pointer-events: none;
          border-radius: inherit;
        }
        .pill:hover {
        ...
        .badge-verified {
          ...
          backdrop-filter: blur(20px);
          color: #f0fdf4;
          box-shadow: 0 4px 24px rgba(0,0,0,.15), inset 0 1px 1px rgba(255,255,255,.2);
          border: 1px solid rgba(255,255,255,0.22);
          animation: float 5s .5s ease-in-out infinite;
        }
        .badge-lab {
          top: 38%; left: -2%;
          background: linear-gradient(135deg, rgba(5,150,105,0.85), rgba(15,61,46,0.85));
          backdrop-filter: blur(16px);
          color: #d1fae5;
          box-shadow: 0 4px 24px rgba(5,150,105,.30), inset 0 1px 1px rgba(255,255,255,.10);
        ...
        .trust-bar {
          position: relative;
          z-index: 10;
          background: linear-gradient(180deg, rgba(5,18,12,0.70) 0%, rgba(5,18,12,0.85) 100%);
          backdrop-filter: blur(20px);
      ...
      <section className="hero-root">
        ...
        {/* ── Background blobs (layered above video for extra depth) ── */}
        <div className="hero-bg">
          <div className="blob blob-1" />
          <div className="blob blob-2" />
          <div className="blob blob-3" />
