        ...
        <Section id="db" title="Database Tables" icon={Database}>
          ...
          <Table
            ...
            rows={[
              ...
              ['orders', 'id (serial)', 'user_id, status (0-9), total_amount, payment_method, payment_status, razorpay_order_id, razorpay_payment_id, address_id, coupon_id, discount_amount, wallet_used, loyalty_points_used, cod_otp, shipped_at, courier_name, tracking_number, tracking_token (UUID), gift_card_code, gift_card_discount, gift_wrap (boolean), gift_message (text)', 'tracking_token: UUID for public order tracking at /track/:token. gift_card_* columns: applied gift card code and deduction amount. gift_wrap/gift_message: set at checkout — admin sees a green 🎁 banner on order detail when gift_wrap=TRUE.'],
        ...
        <Section id="api" title="API Reference (All Routes)" icon={Globe}>
          ...
          {[
            ...
            },
            {
              ...
              routes: [
                ['GET', '/public', 'public', 'List all active products. Query params: ?category=&search=&page=&limit=&sortBy=&sortOrder=&brand_id=&is_featured=true&is_bestseller=true&tag=winter&inStock=true&discount=true&minPrice=&maxPrice=&rating=. The tag param filters by JSONB tags array (ILIKE match) — use seasonal tags (winter/summer/monsoon/autumn) for the Seasonal Picks home section.'],
