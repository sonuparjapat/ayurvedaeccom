...
const s = StyleSheet.create({
  ...
  howCardDesc: { fontFamily: Fonts.regular, fontSize: 11, color: Colors.textDim, textAlign: 'center' },
  ...
  txDate: { fontFamily: Fonts.regular, fontSize: 12, color: Colors.textDim },
  ...
  emptySub: { fontFamily: Fonts.regular, fontSize: 13, color: Colors.textDim },
})
